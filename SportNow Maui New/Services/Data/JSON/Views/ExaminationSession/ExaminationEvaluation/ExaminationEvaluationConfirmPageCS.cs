	...
	public class ExaminationEvaluationConfirmPageCS : DefaultPage
	{
		...
		public async void createExaminationsEvaluation()
		{
			...
			collectionViewExaminationSessionCall.ItemTemplate = new DataTemplate(() =>
			{
				...
				Label nameLabel = new Label { BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = 15, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
				...
				Label gradeTypeLabel = new Label { BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = 13, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
				...
				Label gradeLabel = new Label { BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = 13, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
