...
namespace SportNow.Views
{
    public class ChangePasswordPageCS : DefaultPage
	{
		...
		public void initSpecificLayout()
		{
            ...
            grid.ColumnDefinitions.Add(new ColumnDefinition { Width = App.screenWidth/2 - 5 * App.screenWidthAdapter }); //GridLength.Auto
			grid.ColumnDefinitions.Add(new ColumnDefinition { Width = App.screenWidth/2 - 5 * App.screenWidthAdapter }); //GridLength.Auto 
            ...
            absoluteLayout.SetLayoutBounds(grid, new Rect(0, 20 * App.screenHeightAdapter, App.screenWidth, App.screenHeight - 120 * App.screenHeightAdapter));
