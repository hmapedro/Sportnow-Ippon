...
namespace SportNow.Views.Profile
{
    public class ObjectivesPageCS : DefaultPage
    {
        ...
        public async void initSpecificLayout()
        {
            ...
            absoluteLayout.SetLayoutBounds(usernameLabel, new Rect((App.screenWidth) - (300 * App.screenWidthAdapter), 2 * App.screenHeightAdapter, 300 * App.screenHeightAdapter, 30 * App.screenHeightAdapter));
            ...
            absoluteLayout.SetLayoutBounds(objetivosExplicacaoLabel, new Rect(10 * App.screenWidthAdapter, 70 * App.screenHeightAdapter, App.screenWidth, 130 * App.screenHeightAdapter));
            ...
            absoluteLayout.SetLayoutBounds(objetivosEntry, new Rect(5 * App.screenWidthAdapter, 200 * App.screenHeightAdapter, App.screenWidth - (10 * App.screenHeightAdapter), 400 * App.screenHeightAdapter));
