...
namespace SportNow.Views.Profile
{
    public class ApproveRegistrationPageCS : DefaultPage
    {
		...
		public async void createClassPicker(string membername, string dojoid)
		{
			...
			cancelButton = new CancelButton("CANCELAR", App.screenWidth - 10 * App.screenWidthAdapter, 50 * App.screenHeightAdapter);
		...
		public void CreateClassesColletion()
		{
			...
			classesCollectionView = new CollectionView
			{
				...
				EmptyView = new ContentView
				{
					Content = new Microsoft.Maui.Controls.StackLayout
					{
						Children =
							{
								new Label { FontFamily = "futuracondensedmedium", Text = "Não existem Classes.", HorizontalTextAlignment = TextAlignment.Center, TextColor = Colors.White, FontSize = 20 },
							}
					}
				}
			};
			...
			classesCollectionView.ItemTemplate = new DataTemplate(() =>
			{
				...
				Label nameLabel = new Label { BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Center, FontSize = 20 * App.screenWidthAdapter, TextColor = Colors.White };
