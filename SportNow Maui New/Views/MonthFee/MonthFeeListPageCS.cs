	...
	public class MonthFeeListPageCS : DefaultPage
	{
		...
		public void CreateMonthFeesColletion()
		{
			...
			monthFeesCollectionView = new CollectionView
			{
				...
				EmptyView = new ContentView
				{
					Content = new Microsoft.Maui.Controls.StackLayout
					{
						Children =
							{
								new Label { FontFamily = "futuracondensedmedium", Text = "Não existem Mensalidades deste Dojo para este mês.", HorizontalTextAlignment = TextAlignment.Center, TextColor = Colors.White, FontSize = 20 },
							}
					}
				}
			};
			...
			monthFeesCollectionView.ItemTemplate = new DataTemplate(() =>
			{
                ...
                Label nameLabel = new Label { FontFamily = "futuracondensedmedium", BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = App.titleFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
				...
				Label valueLabel = new Label { FontFamily = "futuracondensedmedium", BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = App.titleFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
				...
				Label statusLabel = new Label { FontFamily = "futuracondensedmedium", BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = App.titleFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
