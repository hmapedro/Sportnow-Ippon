	...
	public class MonthFeeStudentListPageCS : DefaultPage
	{
		...
		public void CreateMonthFeesColletion()
		{
			...
			monthFeesCollectionView = new CollectionView
			{
				...
				EmptyView = new ContentView
				{
					Content = new Microsoft.Maui.Controls.StackLayout
					{
						Children =
							{
								new Label { Text = "Não existem Mensalidades relativas a este ano.", HorizontalTextAlignment = TextAlignment.Center, TextColor = Colors.White, FontSize = 20 },
							}
					}
				}
			};
			...
			monthFeesCollectionView.ItemTemplate = new DataTemplate(() =>
			{
				...
				Label monthLabel = new Label { FontFamily = "futuracondensedmedium", BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = App.itemTitleFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
				...
				Label valueLabel = new Label { FontFamily = "futuracondensedmedium", BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = App.itemTitleFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
				...
				Label statusLabel = new Label { FontFamily = "futuracondensedmedium", BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = App.itemTitleFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
