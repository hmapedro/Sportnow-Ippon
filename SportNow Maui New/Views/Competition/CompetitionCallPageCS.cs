	...
	public class CompetitionCallPageCS : DefaultPage
	{
		...
		public void CreateCompetitionCallColletionView()
		{
			...
			collectionViewCompetitionCall.ItemTemplate = new DataTemplate(() =>
			{
				...
				Label nameLabel = new Label { FontFamily = "futuracondensedmedium", BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = 15, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
				...
				Label categoryLabel = new Label { FontFamily = "futuracondensedmedium", BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = 13, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
