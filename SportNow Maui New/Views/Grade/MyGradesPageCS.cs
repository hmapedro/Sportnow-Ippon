...
namespace SportNow.Views
{
	public class myGradesPageCS : DefaultPage
	{
		...
		{
            Debug.Print("myGradesPageCS.initSpecificLayout BEGIN");
            //member = App.member;
            ...
            Debug.Print("myGradesPageCS.initSpecificLayout END");
        }

		public void CreateStackButtons(string type)
		{
            Debug.Print("myGradesPageCS.CreateStackButtons");
		...
		{
            Debug.Print("myGradesPageCS.CreateGraduacoesTiming Begin");
            ...
            Label monthsLabel = new Label { FontFamily = "futuracondensedmedium", VerticalTextAlignment = TextAlignment.Start, HorizontalTextAlignment = TextAlignment.Center, FontSize = App.itemTitleFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.NoWrap };
            ...
            Label monthsValueLabel = new Label { FontFamily = "futuracondensedmedium", HorizontalTextAlignment = TextAlignment.Center, FontSize = App.itemTitleFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.NoWrap };
            ...
            Label classesLabel = new Label { FontFamily = "futuracondensedmedium", VerticalTextAlignment = TextAlignment.Start, HorizontalTextAlignment = TextAlignment.Center, FontSize = App.itemTitleFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.NoWrap };
            classesLabel.Text = "Aulas Necessárias";

            graduacaoTimingabsoluteLayout.Add(classesLabel);
            graduacaoTimingabsoluteLayout.SetLayoutBounds(classesLabel, new Rect((App.screenWidth) - 120 * App.screenWidthAdapter, 40 * App.screenHeightAdapter , 120 * App.screenWidthAdapter, 30 * App.screenHeightAdapter));

            Label classesValueLabel = new Label { FontFamily = "futuracondensedmedium", HorizontalTextAlignment = TextAlignment.Center, FontSize = App.itemTitleFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.NoWrap };
            ...
            absoluteLayout.SetLayoutBounds(graduacaoTimingabsoluteLayout, new Rect(0, App.screenHeight - 230 * App.screenHeightAdapter, App.screenWidth, 120 * App.screenHeightAdapter));

            Debug.Print("myGradesPageCS.CreateGraduacoesTiming End");
        }


        public async void CreateMinhasGraduacoesColletion()
		{
            Debug.Print("myGradesPageCS.CreateMinhasGraduacoesColletion Begin");
			...
			collectionViewExaminations = new CollectionView {
				...
				EmptyView = new ContentView
				{
					Content = new Microsoft.Maui.Controls.StackLayout
					{
						Children =
							{
								new Label { Text = "Não tem exames registados.", HorizontalTextAlignment = TextAlignment.Start, TextColor = Colors.White, FontSize = App.itemTitleFontSize },
							}
					}
				}
			};
			...
			collectionViewExaminations.ItemTemplate = new DataTemplate(() =>
			{
				...
				Label gradeLabel = new Label { FontFamily = "futuracondensedmedium", HorizontalTextAlignment = TextAlignment.Center, FontSize = App.itemTitleFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.NoWrap };
				gradeLabel.SetBinding(Label.TextProperty, "grade");

				//Label locationLabel = new Label { HorizontalTextAlignment = TextAlignment.Center, TextColor = Colors.White, LineBreakMode = LineBreakMode.NoWrap};
        ...
        {
            Debug.Print("myGradesPageCS.CreateProgramasExame Begin");
            ...
            Debug.Print("myGradesPageCS.CreateProgramasExame End");
        }
		...
		{
            Debug.Print("myGradesPageCS.OnMinhasGraduacoesButtonClicked Begin");
		...
		{
            Debug.Print("myGradesPageCS.OnProgramasExameButtonClicked Begin");
