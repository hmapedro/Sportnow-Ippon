...
{
	public class GradeProgramPageCS_ : DefaultPage
	{
		...
		public async void CreateProgramasExameColletion()
		{
            ...
            Syncfusion.Maui.Accordion.SfAccordion accordion = new Syncfusion.Maui.Accordion.SfAccordion()
			{
				HeightRequest = 300,
            ...
            Label gradeLabel = new Label { Text = "Label", FontFamily = "futuracondensedmedium", HorizontalTextAlignment = TextAlignment.Start, TextColor = Colors.White, TextDecorations = TextDecorations.Underline, LineBreakMode = LineBreakMode.NoWrap, FontSize = App.titleFontSize };
            ...
            accordionItem.Content = gridDetail;

            accordion.Items.Add(accordionItem);

            absoluteLayout.Add(accordion);
            absoluteLayout.SetLayoutBounds(accordion, new Rect(0, 400 * App.screenHeightAdapter, App.screenWidth, App.screenHeight - 160 * App.screenHeightAdapter));
			...
			programasExameCollectionView.ItemTemplate = expandedTemplate;
            ...
            //absoluteLayout.SetLayoutBounds(programasExameCollectionView, new Rect(0, 60 * App.screenHeightAdapter, App.screenWidth, 200));

        }

		public GradeProgramPageCS_(string type)
		{
			this.initLayout();
