	...
	public class QuotasListPageCS : DefaultPage
	{
		...
		{			
			...
			collectionViewPastQuotas = new CollectionView
			{
				...
				EmptyView = new ContentView
				{
					Content = new Microsoft.Maui.Controls.StackLayout
					{
						Children =
							{
								new Label { FontFamily = "futuracondensedmedium", Text = "Não existem quotas anteriores.", HorizontalTextAlignment = TextAlignment.Center, TextColor = Colors.White, FontSize = App.itemTitleFontSize },
							}
					}
				}
			};
			...
			collectionViewPastQuotas.ItemTemplate = new DataTemplate(() =>
			{
                ...
                Label periodLabel = new Label { FontFamily = "futuracondensedmedium", BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = App.itemTextFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
				...
				Label nameLabel = new Label { FontFamily = "futuracondensedmedium", BackgroundColor = Colors.Transparent, VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Start, FontSize = App.itemTextFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
