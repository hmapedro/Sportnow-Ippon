	...
	public class PersonalCoachPageCS : DefaultPage
	{
        ...
        public void CreateCoachColletion()
		{
            ...
            coachsCollectionView = new CollectionView
			{
                ...
                EmptyView = new ContentView
				{
					Content = new Microsoft.Maui.Controls.StackLayout
					{
						Children =
							{
								new Label { FontFamily = "futuracondensedmedium", Text = "Não existem Treinadores Pessoais disponíveis.", HorizontalTextAlignment = TextAlignment.Center, TextColor = Colors.White, FontSize = 20 },
							}
					}
				}
			};
			...
			coachsCollectionView.ItemTemplate = new DataTemplate(() =>
			{
                ...
                Label personalCV_Label = new Label { FontFamily = "futuracondensedmedium", VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Center, FontSize = App.menuButtonFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
                ...
                Label disponibilidadeLabel = new Label { FontFamily = "futuracondensedmedium", VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Center, FontSize = App.menuButtonFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
                ...
                Label valor_intervaloLabel = new Label { FontFamily = "futuracondensedmedium", VerticalTextAlignment = TextAlignment.Center, HorizontalTextAlignment = TextAlignment.Center, FontSize = App.menuButtonFontSize, TextColor = Colors.White, LineBreakMode = LineBreakMode.WordWrap };
