...
namespace SportNow.Views
{
	public class AttendanceMonthPageCS : DefaultPage
	{
			...
			class_attendanceCollectionView = new CollectionView
			{
				...
				EmptyView = new ContentView
				{
					Content = new Microsoft.Maui.Controls.StackLayout
					{
						Children =
							{
								new Label { Text = "Não existem Alunos inscritos nesta aula.", HorizontalTextAlignment = TextAlignment.Center, TextColor = Colors.White, FontSize = 20 },
							}
					}
				}
			};
		...
		public void CreateConfirmButton()
		{
			...
			RoundButton confirmButton = new RoundButton("CONFIRMAR PRESENÇAS", App.screenWidth - 10 * App.screenWidthAdapter, 50 * App.screenHeightAdapter);
