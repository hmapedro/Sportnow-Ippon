...
namespace SportNow.Views
{
	public class AttendanceClassPageCS : DefaultPage
	{
			...
			class_attendanceCollectionView = new CollectionView
			{
				...
				EmptyView = new ContentView
				{
					Content = new Microsoft.Maui.Controls.StackLayout
					{
						Children =
							{
								new Label { FontFamily = "futuracondensedmedium", Text = "Não existem Alunos inscritos nesta aula.", HorizontalTextAlignment = TextAlignment.Center, TextColor = Colors.White, FontSize = 20 },
							}
					}
				}
			};
		...
		public void CreateConfirmButton()
		{
            ...
            absoluteLayout.SetLayoutBounds(confirmButton, new Rect(0, App.screenHeight - 100 - 60 * App.screenHeightAdapter, App.screenWidth, 50 * App.screenHeightAdapter));
		}
